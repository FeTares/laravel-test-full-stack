                                ...
                                <div class="tab-pane active show" id="settings">
                                    <form @submit.prevent="updateInfo" class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                            <img v-bind:src="form.photo_url" width="100" alt="profile_photo">
                                            <!-- <input type="file" @change="selectFile" class="form-control" id="inputPhoto" placeholder="Photo" :class="{ 'is-invalid': form.errors.has('photo') }"> -->
                                            <!-- <input type="file" @change="selectFile"> -->
                                            <input type="file" @change='selectFile' :class="{ 'is-invalid': form.errors.has('photo') }" name="photo">
